...
1. Search [GitHub](https://github.com/DagonMetric/ng-translit/pulls) for an open or closed PR that relates to your submission. You don't want to duplicate effort.

2. [Fork](https://help.github.com/articles/fork-a-repo/) the [repo](https://github.com/DagonMetric/ng-translit) and create your branch `topic` from master.
...
8. In GitHub, submit a [pull request](https://help.github.com/articles/about-pull-requests) to [DagonMetric/ng-translit](https://github.com/DagonMetric/ng-translit).
